const projects = [
    ...
    { 
      title: 'Search Food by Recipe', 
      description: 'A web application that allows users to search for recipes based on available ingredients, providing detailed instructions and video', 
      img: '/images/1.png', 
    ...
    { 
      ...
      { 
        ...
        img: '/images/5.png', 
        url: 'https://easy-banking-zqc6.onrender.com',
        sourceUrl: 'https://github.com/Eunini/EasyBanking'
      },
      { 
        title: 'BurgerVilla', 
        description: 'An online landing system for a burger restaurant, giving customers detail about the restaurant.', 
        img: '/images/6.png', 
